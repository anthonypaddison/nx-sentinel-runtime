/* nx-displaygrid - Home Assistant Lit helper (no bundler)
...
export function getHaLit() {
    ...
    if (!LovelacePanel) {
        throw new Error('nx-displaygrid: ha-panel-lovelace not found. (Lovelace not ready yet)');
    }
    ...
    if (!LitElement || !html || !css) {
        throw new Error('nx-displaygrid: could not access LitElement/html/css from HA.');
    }
